...
| <a name="input_redis_suffix_name_enabled"></a> [redis\_suffix\_name\_enabled](#input\_redis\_suffix\_name\_enabled) | Enable the redis suffix at the end of the replication group identifier | `bool` | `true` | no |
